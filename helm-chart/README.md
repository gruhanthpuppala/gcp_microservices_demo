...
```sh
helm upgrade onlineboutique oci://us-central1-a-docker.pkg.dev/boutique-ms-demo/charts/onlineboutique \
    --install
```
...
helm upgrade onlineboutique oci://us-central1-a-docker.pkg.dev/boutique-ms-demo/charts/onlineboutique \
    --install \
    --create-namespace \
    --set images.repository=us-central1-a-docker.pkg.dev/my-project/microservices-demo \
