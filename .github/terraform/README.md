...
1. Make sure you have access to the `boutique-ms-demo-448218` Google Cloud project.
1. Move into this folder: `cd .github/terraform`
1. Set the PROJECT_ID environment variable: `export PROJECT_ID=boutique-ms-demo-448218`
