...
By default, Online Boutique's services' container images are pulled from a public container registry (`us-central1-a-docker.pkg.dev/google-samples/microservices-demo`). One best practice is to have these container images in your own private container registry. The Kustomize variation in this folder can help with using your own private container registry.
...
```bash
REGISTRY=my-registry # Example: us-central1-a-docker.pkg.dev/my-project/my-directory
